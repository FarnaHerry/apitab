// common.cppm — HuxerUI 前端公共小组件（页面标题、状态文本、占位页）。
module;

#include <huxerui/huxerui.h>

export module apitab.ui.common;
...
// 页面标题 + 副标题。
[[huxerui::composable]] inline huxerui::View PageHeader(std::string title, std::string subtitle) {
...
// 尚未迁移完成的页面占位。
[[huxerui::composable]] inline huxerui::View MigrationPlaceholder(std::string pageName) {
    const huxerui::ThemeSpec& theme = huxerui::UseTheme();
    return huxerui::Column {
